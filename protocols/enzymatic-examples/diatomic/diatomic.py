...
def create_system(
    ...
    **kwargs,
    ...
    if reaction:
        ...
        logger.debug('Skipping reactions')
...
def plot_final(data: pd.DataFrame, name: str = 'diatomic'):
    fig, ax = plt.subplots()
    params = dict(
